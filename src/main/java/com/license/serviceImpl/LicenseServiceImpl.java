...
public class LicenseServiceImpl implements LicenseService {
	...
	public License createLicense(License license, HttpSession session) {
		...
		UserDtls currentUser = (UserDtls) session.getAttribute("loggedInUser");
	...
	public static void encryptSensitiveInfo(License license) {
		...
		try {
			...
			String fileName = "C:\\Users\\Asus\\OneDrive\\Desktop\\encrypted_License_Data_" + timestamp + ".txt";
	...
	public static void generatePlainTextFile(License license) {
		...
		try {
			...
			// Construct the file name with the timestamp
			String fileName = "C:\\Users\\Asus\\OneDrive\\Desktop\\licenseKey_" + timestamp + ".txt";
...
//	private Date calculateExpirationDate(int months) {
